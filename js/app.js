...
function bindOrderForm() {
    ...
    form.addEventListener('submit', async (event) => {
        ...
        try {
            const response = await fetch('api/shop_orders.php', {
                method: 'POST',
...
if (productsBtn) {
    productsBtn.addEventListener('click', () => loadData('api/products.php', 'Products'));
}

if (customersBtn) {
    customersBtn.addEventListener('click', () => loadData('api/customers.php', 'Customers'));
}

if (ordersBtn) {
    ordersBtn.addEventListener('click', () => loadData('api/orders.php', 'Orders'));
}
